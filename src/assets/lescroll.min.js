var leScroll = (function(e) {
  ...
  return (
    (e.scrolling = !1),
    (e.move = function() {
      document.getElementById("container").style.top = i
        ? "-" + t * n + "px"
...
!(function(e, t, o) {
  ...
  for (
    var n = t.getElementsByTagName("li"),
      ...
      l = function(t) {
        var o = 0,
          n = t || e.event;
        n.wheelDelta
          ? (o = ((e.opera ? -1 : 1) * n.wheelDelta) / 120)
      ...
      c = function(e) {
        o.scrolling ||
          (e > 0
            ? ((o.scrolling = !0), o.moveUp(), o.setScrollTimeout(1500))
            : 0 >= e &&
              ((o.scrolling = !0), o.moveDown(), o.setScrollTimeout(1500)));
      },
      r = function() {
    ...
    n[u].getAttribute("data-section") && n[u].addEventListener("click", r);
  e.addEventListener("keydown", function(e) {
    ...
    e.addEventListener("DOMMouseScroll", l, !1),
    (e.onmousewheel = t.onmousewheel = l);
